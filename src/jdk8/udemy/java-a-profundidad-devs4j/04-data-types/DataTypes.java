class DataTypes {
  ...
  public static void main(String[] args) {
    ...
    char character = 'Z';
    int size = 12341354;
    // The literal for the decimal 123.45 is always double, for float add "F" in
    // lowercase or upppercase.
    float surface = 21564.145F;
    // The literal for the decimal 12345 is always integer, for long add "L" in
    // lowercase or upppercase.
